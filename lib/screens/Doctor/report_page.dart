...
class _MedicalReportPageState extends State<MedicalReportPage>
  ...
  Widget _buildInfoGrid(RecordsListModel record) {
    ...
    final items = [
      ...
      {'label': 'Body Part', 'value': record.bodyPartExamined ?? '-', 'icon': Icons.accessibility_new_rounded, 'editable': true},
    ];
    ...
    return GridView.builder(
      ...
      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
        ...
        childAspectRatio: 7.0, // Adjusted for slightly taller boxes to fit larger text, smaller than 7.0 but larger than 4.0
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(icon, size: 16, color: Colors.grey.shade600), // Larger icon
              const SizedBox(width: 4), // Increased spacing
              Text(
                label,
                style: TextStyle(
                  fontSize: 12, // Larger font for label
    ...
    if (!_isEditingReport) {
      return Container(
        ...
        child: Row(
          ...
          children: [
            Icon(_getStatusIcon(), color: _getStatusColor(), size: 16), // Smaller icon for very compact box
            const SizedBox(width: 4), // Smaller spacing
            Text(
              _selectedReportStatus ?? 'Normal',
              style: TextStyle(
                fontSize: 12, // Smaller font for very compact box
                fontWeight: FontWeight.w600,
